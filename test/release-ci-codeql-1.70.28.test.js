...
test('1.71.22 launches JavaScript crypto providers through Node for Windows execFile compatibility', (t) => {
...
test('1.71.22 static regex inventory avoids the CodeQL exponential-backtracking pattern', () => {
