...
test('1.60.0 launcher is a conventional C# WinForms UI with no Go launcher left', () => {
  assert.match(launcher, /const string AppVersion = "1\.60\.0"/);
  assert.match(launcher, /const string RuntimeAppBuild = "1\.60\.0-launcher35-csharp"/);
