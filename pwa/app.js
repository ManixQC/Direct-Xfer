...
(function () {
  ...
  var APP_VERSION = '1.71.42';
  var APP_BUILD = '2026.08.27-pwa505';
...
Object.assign(STRINGS.fr, { imgVersionHistory:'Historique des modifications', imgCompareBeforeAfter:'Comparer avant/après', imgRestoreOriginal:'Revenir à l’original', imgCurrentVersion:'Version actuelle', imgVersionOperations:'Opérations', imgClose:'Fermer', imgRestoreConfirm:'Restaurer cette version ?', imgOriginal:'Originale' });
  ...
  function applyLanguage(next) {
    ...
    if (manifest) {
      ...
      var manifestHref = '/direct-xfer-pwa.webmanifest?v=486';
      if (lang === 'en') manifestHref = '/direct-xfer-pwa-en.webmanifest?v=486';
      else if (lang === 'es') manifestHref = '/direct-xfer-pwa-es.webmanifest?v=486';
  ...
  function registerServiceWorker() {
    ...
    var registrationPromise = navigator.serviceWorker.register('/direct-xfer-pwa-sw.js?v=486', { scope: '/app/' }).then(function (reg) {
      swReg = reg;
