...
(function () {
  ...
  var APP_VERSION = '1.71.12';
  var APP_BUILD = '2026.08.26-pwa475';
...
Object.assign(STRINGS.fr, { imgVersionHistory:'Historique des modifications', imgCompareBeforeAfter:'Comparer avant/après', imgRestoreOriginal:'Revenir à l’original', imgCurrentVersion:'Version actuelle', imgVersionOperations:'Opérations', imgClose:'Fermer', imgRestoreConfirm:'Restaurer cette version ?', imgOriginal:'Originale' });
  ...
  function applyLanguage(next) {
    ...
    if (manifest) {
      ...
      var manifestHref = '/direct-xfer-pwa.webmanifest?v=456';
      if (lang === 'en') manifestHref = '/direct-xfer-pwa-en.webmanifest?v=456';
      else if (lang === 'es') manifestHref = '/direct-xfer-pwa-es.webmanifest?v=456';
  ...
  function registerServiceWorker() {
    ...
    var registrationPromise = navigator.serviceWorker.register('/direct-xfer-pwa-sw.js?v=456', { scope: '/app/' }).then(function (reg) {
      swReg = reg;
