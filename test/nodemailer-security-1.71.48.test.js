...
test('1.71.48 resolves Nodemailer at the audited 9.1.1 security floor', () => {
...
test('1.71.48 SBOM reports the same Nodemailer version as package-lock.json', () => {
  const lock = readJson('package-lock.json');
...
test('1.71.48 OpenVEX marks the four Nodemailer advisories fixed', () => {
