...
const ROUTE_DEPENDENCIES = Object.freeze({
  ...
  adminAccount: Object.freeze([
    ...
    "customNotificationRuleTargets", "getCustomNotificationRuleMetrics", "upsertCustomNotificationRule", "deleteCustomNotificationRule", "addCenterNotification", "auditReq", "persistNow", "crypto", "appName",
  ...
  adminSecurity: Object.freeze([
    ...
    "anomalyWindows", "persistNow", "auditReq", "crypto", "sessionService", "authService", "getAccountById", "publicIp", "invalidateSessionSid", "secureCookie",
  ...
  adminStorage: Object.freeze([
    ...
    "googleOAuthBrokerUrl", "googleOAuthBrokerManaged", "ASVS_L3_MODE", "ASVS_L3_EGRESS_ALLOWLIST", "getStorageConnector", "cleanConnectorPath", "connectorErrorCode", "connectorHttpStatus", "connectorStore", "publicConnector",
  ...
  adminPhoto: Object.freeze([
    "ASVS_L3_MODE", "DAY_MS", "FULL_IMAGES_DIR", "HOST_ROOT", "IMAGE_MAX_BYTES", "IMAGE_MAX_PIXELS", "IMAGE_STORE_DIR", "MICROS_DIR", "MICRO_MAX_BYTES", "PWA_IMG_EXT",
    ...
    "restorePlainObject", "sanitizeImageMetadataFile", "stagePhotoHistoryPreviewRemoval", "stampOwner", "stampPhotoUploadDevice", "streamFile", "streamToFileBounded", "unlinkManagedPathsStrict", "unlinkPhotoFiles",
  ...
  adminDiagnostics: Object.freeze([
    "CLAMAV_HOST", "CLAMAV_PORT", "DATA_DIR", "DATA_KEY", "ASVS_L3_MODE", "HOST_ROOT", "IMAGE_STORE_DIR", "INBOX_DIR", "PORT",
