...
test('1.67.3 keeps optional helpers opt-in with explicit activation markers', () => {
...
test('default Windows payload still excludes rclone and Tesseract in 1.67.3', () => {
  assert.match(workflow, /DX_VERSION: '1\.67\.3'/);
