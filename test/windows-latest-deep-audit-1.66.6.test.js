...
<<<<<<< HEAD
test('1.71.3 version, Windows builds and PWA generation are synchronized', () => {
  assert.equal(pkg.version, '1.71.3');
  assert.equal(lock.version, '1.71.3');
  assert.equal(lock.packages[''].version, '1.71.3');
  assert.match(workflow, /^run-name: v1\.71\.3$/m);
=======
test('1.71.4 version, Windows builds and PWA generation are synchronized', () => {
  assert.equal(pkg.version, '1.71.4');
  assert.equal(lock.version, '1.71.4');
  assert.equal(lock.packages[''].version, '1.71.4');
...
<<<<<<< HEAD
    assert.match(read(rel), /1\.71\.3|pwa466/);
=======
    assert.match(read(rel), /1\.71\.4|pwa467/);
>>>>>>> eb50626 (v1.71.4)
  }
