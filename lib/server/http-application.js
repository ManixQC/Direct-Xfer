  ...
  app.use((req, res, next) => {
    ...
    requestContext.run({ cspNonce }, () => {
      ...
      res.setHeader(
        ...
        `default-src 'self'; script-src 'self' 'nonce-${cspNonce}'; script-src-attr 'none'; ` +
          `style-src 'self' 'nonce-${cspNonce}'; style-src-elem 'self' 'nonce-${cspNonce}'; style-src-attr 'unsafe-inline'; ` +
