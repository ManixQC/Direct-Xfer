...
test('1.71.28 launches JavaScript crypto providers through Node for Windows execFile compatibility', (t) => {
...
test('1.71.28 static regex inventory avoids the CodeQL exponential-backtracking pattern', () => {
