...
function createAccountService(options = {}) {
  ...
  function warnLegacyPredictableOwner(username) {
    ...
    warn('[accounts] ASVS L3 preserved a predictable legacy owner username for upgrade compatibility; rename it from the admin interface when practical:', username);
  }
