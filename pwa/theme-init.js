...
(function () {
  ...
  var release = { version: '1.65.1', build: '2026.08.18-pwa341' };
  ...
  if (!document.querySelector('script[data-dx-admin-advanced]')) {
    ...
    adminScript.src = '/app/admin-advanced.js?v=341';
  ...
  if (!document.querySelector('script[data-dx-admin-audit-connectors]')) {
    ...
    auditConnectorScript.src = '/app/admin-audit-connectors.js?v=341';
