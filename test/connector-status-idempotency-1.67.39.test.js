...
test('1.69.0 confirmed connector inventory is not replaced by a stale red load error', () => {
...
test('1.69.0 successful POST or PATCH confirms the inventory before background refresh', () => {
...
test('1.69.0 exact connector POST retries are idempotent', () => {
