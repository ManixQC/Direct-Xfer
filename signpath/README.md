...
Direct-Xfer 1.71.32 is prepared for SignPath Foundation Open Source Code Signing. Source-side preparation is complete; the remaining work is the one-time external SignPath approval/configuration and GitHub secret/variable setup.
