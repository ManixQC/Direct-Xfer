# Direct-Xfer 1.71.2 — ASVS L3 release evidence
...
| Complete current regression tree | PASS | 1133 passed, 0 failed, 0 skipped; all 189 `test/*.test.js` files verified in twelve isolated groups |
...
| Security inventory | PASS | Regenerated for 1.71.2; 959 inventory entries |
...
| CycloneDX SBOM | PASS | Root component synchronized to Direct-Xfer 1.71.2 |
