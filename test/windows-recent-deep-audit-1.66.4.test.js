...
test('1.71.35 bump advances the PWA cache generation so changed release metadata is not served from pwa353', () => {
  ...
  for (const rel of ['pwa/app.js', 'pwa/index.html', 'pwa/sw.js', 'pwa/theme-init.js', 'pwa/admin-advanced.js', 'pwa/mobile-intelligence.js']) {
    ...
    assert.match(source, new RegExp(`${releaseRe}|pwa498|v=479`));
