...
test('1.71.12 final image omits Debian Tesseract binaries and keeps only required OCR language/runtime packages', () => {
...
test('1.71.12 OpenVEX is narrow, package-scoped, and removes the old unsound Cairo suppression', () => {
  assert.equal(openvex['@id'], 'https://github.com/ManixQC/Direct-Xfer/security/openvex-1.71.12');
...
test('1.71.12 keeps the intentional Docker root bootstrap exception narrow and reviewable', () => {
...
test('1.71.12 Trivy produces a complete report but gates only fixable, VEX-reviewed findings', () => {
