...
(function () {
  ...
  var APP_VERSION = '1.71.6';
  var APP_BUILD = '2026.08.25-pwa469';
...
Object.assign(STRINGS.fr, { imgVersionHistory:'Historique des modifications', imgCompareBeforeAfter:'Comparer avant/après', imgRestoreOriginal:'Revenir à l’original', imgCurrentVersion:'Version actuelle', imgVersionOperations:'Opérations', imgClose:'Fermer', imgRestoreConfirm:'Restaurer cette version ?', imgOriginal:'Originale' });
  ...
  function applyLanguage(next) {
    ...
    if (manifest) {
      ...
      var manifestHref = '/direct-xfer-pwa.webmanifest?v=450';
      if (lang === 'en') manifestHref = '/direct-xfer-pwa-en.webmanifest?v=450';
      else if (lang === 'es') manifestHref = '/direct-xfer-pwa-es.webmanifest?v=450';
  ...
  function registerServiceWorker() {
    ...
    var registrationPromise = navigator.serviceWorker.register('/direct-xfer-pwa-sw.js?v=450', { scope: '/app/' }).then(function (reg) {
      swReg = reg;
