...
(function () {
  ...
  var APP_VERSION = '1.71.41';
  var APP_BUILD = '2026.08.27-pwa504';
...
Object.assign(STRINGS.fr, { imgVersionHistory:'Historique des modifications', imgCompareBeforeAfter:'Comparer avant/après', imgRestoreOriginal:'Revenir à l’original', imgCurrentVersion:'Version actuelle', imgVersionOperations:'Opérations', imgClose:'Fermer', imgRestoreConfirm:'Restaurer cette version ?', imgOriginal:'Originale' });
  ...
  function applyLanguage(next) {
    ...
    if (manifest) {
      ...
      var manifestHref = '/direct-xfer-pwa.webmanifest?v=485';
      if (lang === 'en') manifestHref = '/direct-xfer-pwa-en.webmanifest?v=485';
      else if (lang === 'es') manifestHref = '/direct-xfer-pwa-es.webmanifest?v=485';
  ...
  function registerServiceWorker() {
    ...
    var registrationPromise = navigator.serviceWorker.register('/direct-xfer-pwa-sw.js?v=485', { scope: '/app/' }).then(function (reg) {
      swReg = reg;
