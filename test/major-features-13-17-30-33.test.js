...
test('feature 33 produces an independently verifiable Ed25519 proof and detects tampering', () => {
  ...
  const proof = { proofVersion:1, app:'Direct-Xfer', appVersion:'1.59.2', exportedAt:2, entryCount:1, entriesSha256:digest, head:{ seq:1, hash:entryHash }, publicKeyId, publicKey:publicPem, algorithm:'Ed25519', entries };
