...
Current audited source snapshot: Direct-Xfer `1.71.2` release  
...
Full regression verification: all 189 `test/*.test.js` files in twelve isolated groups — 1133 passed, 0 failed, 0 skipped  
