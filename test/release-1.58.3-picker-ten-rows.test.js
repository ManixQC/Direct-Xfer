...
test('1.59.5 create-share modal is a three-zone bounded grid', () => {
...
test('1.59.5 file picker targets ten visible rows plus parent row', () => {
...
test('1.59.5 release identifiers are synchronized', () => {
  ...
  assert.match(read('windows-launcher','Program.cs'), /RuntimeAppBuild\s*=\s*"1\.59\.5-launcher31-csharp"/);
});
