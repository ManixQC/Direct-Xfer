...
test('1.59.4 create-share dialog has a bounded Firefox-safe scroll body', () => {
...
test('1.59.4 release identifiers are synchronized', () => {
  ...
  assert.match(read('windows-launcher/Program.cs'), /RuntimeAppBuild\s*= "1\.59\.4-launcher30-csharp"/);
});
