...
- Application/package metadata is synchronized to `1.71.19`, with PWA generation `pwa482` and cache-buster `v=463`. OAuth broker metadata, Windows workflow artifacts, SBOM, OpenVEX and ASVS release evidence are synchronized to the release.
...
- Security inventory regenerated for 1.71.19 — **967 entries**.
...
- CycloneDX SBOM root component synchronized to 1.71.19.
...
- [x] package and lockfile version synchronized to 1.71.19.
- [x] PWA version/cache generation synchronized to 1.71.19 / pwa482.
...
- [x] SBOM root component synchronized to 1.71.19.
