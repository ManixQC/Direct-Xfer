...
test('1.62.3 picker uses one bounded dialog body scroller that is Firefox-safe', () => {
...
test('1.62.3 picker file list no longer collapses to roughly three rows', () => {
...
test('1.62.3 computes real pixel heights and explicitly chains Firefox wheel scrolling', () => {
