...
test('1.68.0 successful Google setup updates the remote locally instead of forcing a blocking connector probe', () => {
...
test('1.68.0 connector API bounds optional rclone probing and exposes a neutral pending snapshot', () => {
...
test('1.68.0 connector UI renders pending runtime probes without a red load failure', () => {
