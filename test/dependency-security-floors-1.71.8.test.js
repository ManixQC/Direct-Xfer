...
test('1.71.34 dependency declarations no longer advertise vulnerable Express/node-forge floors', () => {
...
test('1.71.34 lockfile resolves the dependency floors to the audited safe versions', () => {
  assert.equal(lock.version, '1.71.34');
  assert.equal(lock.packages[''].version, '1.71.34');
