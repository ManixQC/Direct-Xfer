...
test('1.67.5 standard + menu uses one fixed icon column for every create-link action', () => {
  const ids = [
...
test('1.67.5 create-menu translations no longer embed icon glyphs that would duplicate the fixed icon column', () => {
