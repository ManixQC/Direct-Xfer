...
test('1.59.1 picker uses one bounded dialog body scroller that is Firefox-safe', () => {
...
test('1.59.1 picker file list no longer collapses to roughly three rows', () => {
...
test('1.59.1 computes real pixel heights and explicitly chains Firefox wheel scrolling', () => {
