# Direct-Xfer 1.70.28 — ASVS L3 release evidence
...
| Complete current regression tree | PASS | 1122 passed, 0 failed, 0 skipped; all 185 `test/*.test.js` files verified in isolated groups |
...
| Security inventory | PASS | Regenerated for 1.70.28; 949 inventory entries |
...
| CycloneDX SBOM | PASS | Root component synchronized to Direct-Xfer 1.70.28 |
