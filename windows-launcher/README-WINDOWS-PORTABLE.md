# Direct-Xfer 1.62.4 — Windows C# / WinForms
...
- launcher : `1.62.4-launcher45-csharp`
- server host : `1.62.4-serverhost18-csharp`
...
- l’artefact `Direct-Xfer-1.62.4-Windows-CSharp` ;
- l’installateur `Direct-Xfer-Setup-1.62.4.exe`.
