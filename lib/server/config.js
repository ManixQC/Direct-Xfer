...
function createServerConfig(options = {}) {
  ...
  const ASVS_L3_CLOCK_SYNCED = bool(env.ASVS_L3_CLOCK_SYNCED);
  const ASVS_L3_MEMORY_PROTECTED = bool(env.ASVS_L3_MEMORY_PROTECTED);
  ...
  const clamavEnabled = () => !!CLAMAV_HOST || ASVS_L3_MODE;
  ...
  const groups = Object.freeze({
    ...
    security:Object.freeze({
      ...
      ASVS_L3_MODE, ASVS_L3_EGRESS_ALLOWLIST, ASVS_L3_CRYPTO_PROVIDER, ASVS_L3_CLOCK_SYNCED, ASVS_L3_MEMORY_PROTECTED,
  ...
  const config = {
    ...
    ASVS_L3_EGRESS_ALLOWLIST, ASVS_L3_CRYPTO_PROVIDER, ASVS_L3_CLOCK_SYNCED, ASVS_L3_MEMORY_PROTECTED,
