...
test('1.68.3 web-reception browser exposes an in-modal new-folder workflow', () => {
...
test('1.68.3 folder names are single safe remote path segments', () => {
...
test('1.68.3 writable connector mkdir creates the folder and returns its selectable path', async () => {
...
test('1.68.3 mkdir rejects duplicates and read-only connectors without mutating cloud storage', async () => {
