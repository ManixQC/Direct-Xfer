...
test('1.59.0 ultra-audit regression file is superseded by the 1.62.4 suite', () => {
  assert.equal(fs.existsSync(path.join(root, 'test', 'recent-changes-ultra-audit-1.62.4.test.js')), true);
