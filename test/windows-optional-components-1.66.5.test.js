...
test('1.68.2 keeps optional helpers opt-in with explicit activation markers', () => {
...
test('default Windows payload still excludes rclone and Tesseract in 1.68.2', () => {
  assert.match(workflow, /DX_VERSION: '1\.68\.2'/);
