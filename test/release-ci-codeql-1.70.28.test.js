...
test('1.71.16 launches JavaScript crypto providers through Node for Windows execFile compatibility', (t) => {
...
test('1.71.16 static regex inventory avoids the CodeQL exponential-backtracking pattern', () => {
