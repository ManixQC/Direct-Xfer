...
<<<<<<< HEAD
Current audited source snapshot: Direct-Xfer `1.71.3` release  
...
Full regression verification: all 189 `test/*.test.js` files — 1134 passed, 0 failed, 0 skipped  
=======
Current audited source snapshot: Direct-Xfer `1.71.4` release  
Baseline archive SHA-256: `6ed5f230e1e73e540a00dc545d3d0098946a8a75257423041492875fe8ef59cb`  
ASVS regression verification: `node --test test/asvs-l3-*.test.js` — 96 passed, 0 failed, 0 skipped  
