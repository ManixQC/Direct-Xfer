...
(function () {
  ...
  var release = { version: '1.71.32', build: '2026.08.26-pwa495' };
  ...
  if (!document.querySelector('script[data-dx-admin-advanced]')) {
    ...
    adminScript.src = '/app/admin-advanced.js?v=476';
  ...
  if (!document.querySelector('script[data-dx-admin-audit-connectors]')) {
    ...
    auditConnectorScript.src = '/app/admin-audit-connectors.js?v=476';
