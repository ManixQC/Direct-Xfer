  ...
  async function serverHealthDeepSnapshot() {
    ...
    serverHealthDeepCache.pending = (async () => {
      ...
      const value = {
        ...
        runtime:ASVS_L3_MODE
          ? { node:null, platform:process.platform, arch:process.arch, hostname:null, pid:null }
          : { node:process.version, platform:process.platform, arch:process.arch, hostname:os.hostname(), pid:process.pid },
      };
