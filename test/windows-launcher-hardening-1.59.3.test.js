...
test('1.62.2 launcher identity is explicit, x64 and independent from server spawning', () => {
  ...
  assert.match(launcherManifest, /version="1\.62\.2\.0"/);
...
test('Node trust and process lifecycle remain confined to ServerHost', () => {
