...
- Security inventory regenerated for 1.72.1 — **1001 entries**.
...
- CycloneDX SBOM root component synchronized to 1.72.1; `qs` synchronized to 6.16.0.
...
- [x] package and lockfile version synchronized to 1.72.1.
- [x] PWA version/cache generation synchronized to 1.72.1 / pwa516 / cache `v=496`.
...
- [x] SBOM root component synchronized to 1.72.1 and `qs` component synchronized to 6.16.0.
