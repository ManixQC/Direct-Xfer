...
test('1.59.4 picker uses one bounded dialog body scroller that is Firefox-safe', () => {
...
test('1.59.4 picker file list no longer collapses to roughly three rows', () => {
...
test('1.59.4 computes real pixel heights and explicitly chains Firefox wheel scrolling', () => {
