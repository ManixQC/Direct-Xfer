...
test('1.59.5 picker uses one bounded dialog body scroller that is Firefox-safe', () => {
...
test('1.59.5 picker file list no longer collapses to roughly three rows', () => {
...
test('1.59.5 computes real pixel heights and explicitly chains Firefox wheel scrolling', () => {
