...
const I18N = {
  fr: {
    ...
    'pk.maxBandwidth': 'Limite totale de bande passante (Go)',
    'pk.emoji': 'Emoji du lien (facultatif)',
  ...
  en: {
    ...
    'pk.maxBandwidth': 'Total bandwidth cap (GB)',
    'pk.emoji': 'Link emoji (optional)',
  ...
  es: {
    ...
    'pk.maxBandwidth': 'Límite total de ancho de banda (GB)',
    'pk.emoji': 'Emoji del enlace (opcional)',
