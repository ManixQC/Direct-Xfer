...
test('1.69.6 creates the rclone config directory before the first Google remote is saved',async()=>{
...
test('1.69.6 identifies rclone config-storage failures instead of connector-failed',async()=>{
...
test('1.69.6 distinguishes Google Drive verification failures and redacts broker credentials',async()=>{
...
test('1.69.6 Google OAuth session API preserves a sanitized rclone diagnostic for the admin UI',()=>{
