# Direct-Xfer 1.59.5 — Windows C# / WinForms
...
- launcher : `1.59.5-launcher31-csharp`
- server host : `1.59.5-serverhost4-csharp`
...
- l’artefact `Direct-Xfer-1.59.5-Windows-CSharp` ;
- l’installateur `Direct-Xfer-Setup-1.59.5.exe`.
