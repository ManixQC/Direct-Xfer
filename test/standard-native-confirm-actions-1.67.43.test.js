...
test('1.69.2 provides an in-app confirmation modal independent of browser confirm()', () => {
...
test('1.69.2 single-share revoke no longer depends on native confirm()', () => {
...
test('1.69.2 transfer history purge uses the in-app confirmation modal', () => {
...
test('1.69.2 bulk share/photo revoke and photo-history purge also avoid native confirm()', () => {
