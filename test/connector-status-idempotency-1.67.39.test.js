...
test('1.69.2 confirmed connector inventory is not replaced by a stale red load error', () => {
...
test('1.69.2 successful POST or PATCH confirms the inventory before background refresh', () => {
...
test('1.69.2 exact connector POST retries are idempotent', () => {
