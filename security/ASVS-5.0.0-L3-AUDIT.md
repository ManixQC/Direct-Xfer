...
- Security inventory regenerated for 1.72.0 — **1001 entries**.
...
- CycloneDX SBOM root component synchronized to 1.72.0; `qs` synchronized to 6.16.0.
...
- [x] package and lockfile version synchronized to 1.72.0.
- [x] PWA version/cache generation synchronized to 1.72.0 / pwa515 / cache `v=495`.
...
- [x] SBOM root component synchronized to 1.72.0 and `qs` component synchronized to 6.16.0.
