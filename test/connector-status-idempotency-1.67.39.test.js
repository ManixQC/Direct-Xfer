...
test('1.68.0 confirmed connector inventory is not replaced by a stale red load error', () => {
...
test('1.68.0 successful POST or PATCH confirms the inventory before background refresh', () => {
...
test('1.68.0 exact connector POST retries are idempotent', () => {
