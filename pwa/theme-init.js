...
(function () {
  ...
  var release = { version: '1.71.8', build: '2026.08.25-pwa471' };
  ...
  if (!document.querySelector('script[data-dx-admin-advanced]')) {
    ...
    adminScript.src = '/app/admin-advanced.js?v=452';
  ...
  if (!document.querySelector('script[data-dx-admin-audit-connectors]')) {
    ...
    auditConnectorScript.src = '/app/admin-audit-connectors.js?v=452';
