...
function configuredSelfSignedTls() {
  // ASVS L3 terminates TLS at the independently verified edge. Never revive
  // legacy Local-CA material from persisted settings in this profile.
  if (ASVS_L3_MODE) return false;
