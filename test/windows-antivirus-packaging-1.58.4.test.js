...
test('1.63.4 launcher is a conventional C# WinForms UI with no Go launcher left', () => {
  assert.match(launcher, /const string AppVersion = "1\.63\.4"/);
  assert.match(launcher, /const string RuntimeAppBuild = "1\.63\.4-launcher52-csharp"/);
