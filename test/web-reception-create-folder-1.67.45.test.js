...
test('1.68.1 web-reception browser exposes an in-modal new-folder workflow', () => {
...
test('1.68.1 folder names are single safe remote path segments', () => {
...
test('1.68.1 writable connector mkdir creates the folder and returns its selectable path', async () => {
...
test('1.68.1 mkdir rejects duplicates and read-only connectors without mutating cloud storage', async () => {
