...
test('1.68.3 provides an in-app confirmation modal independent of browser confirm()', () => {
...
test('1.68.3 single-share revoke no longer depends on native confirm()', () => {
...
test('1.68.3 transfer history purge uses the in-app confirmation modal', () => {
...
test('1.68.3 bulk share/photo revoke and photo-history purge also avoid native confirm()', () => {
