...
test('release and PWA cache identifiers are 1.62.3/pwa307', () => {
  assert.equal(pkg.version, '1.62.3'); assert.match(pwa, /APP_VERSION = '1\.62\.3'/); assert.match(pwa, /2026\.08\.16-pwa307/); assert.match(sw, /2026\.08\.16-pwa307/);
});
