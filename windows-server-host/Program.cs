...
namespace DirectXfer.WindowsServerHost
{
    internal static class Program
    {
        ...
        internal const string ServerHostVersion = "1.70.23";
        internal const string ServerHostBuild = "serverhost143-csharp";
    ...
    internal sealed class LauncherConfig
    {
        ...
        // 0 preserves the historical automatic 55750-55769 fallback range.
        // A positive value pins the backend to that exact user-selected port.
        public int port = 0;
    }
    ...
    internal sealed class ServerHost : IDisposable
    {
        ...
        private static readonly IDictionary<string, string> CriticalRuntimeSha256 =
            ...
            {
                { "package.json", "80877ba36e2157ed99c44c08dfa053393459c16e6ef8360b8827008131c132b9" },
                { "package-lock.json", "e6a2fed202d544aaadaed3d58c4d33e1dac71c0504385e18b7f90cefab0ba744" },
                ...
                { "lib/server/account-service.js", "fbb51fb3df78287909b8aac61f5281841d55a924f2a0d84ed5fcbc46c8103ca5" },
                ...
                { "lib/server/public-pages.js", "ebcd2362e89461f11b469bfbd3df91665a18c804242766936be281d6bdec6708" },
                ...
                { "pwa/app.js", "37a52be982f2e9a65e1ca83fdcdcc67178ee0c9ab5f895f89e4cec2c9e44de4b" },
                ...
                { "public/index.html", "1f3dbe925761eedd922cb0d4cb0988a6ccdd11edf659e672668c41b5ce2ae4d9" },
        ...
        private int RunConfiguredCycle()
        {
            ...
            _port = ChooseRuntimePort(_config.port);
            _token = RandomToken();
            _scheme = "http";
        ...
        private static void NormalizeAndValidateConfig(LauncherConfig? cfg)
        {
            ...
            if (cfg.port < 0 || cfg.port > 65535) throw new InvalidDataException("Configured port must be 0 (automatic) or between 1 and 65535.");
        }
        ...
        private static int ChooseRuntimePort(int configuredPort)
        {
            if (configuredPort > 0)
            {
                if (CanBindPort(configuredPort)) return configuredPort;
                throw new InvalidOperationException("Configured Direct-Xfer port " + configuredPort.ToString(CultureInfo.InvariantCulture) + " is already in use or unavailable.");
            }
        ...
        private static HostSession? ReadSession()
        {
            try
            {
                ...
                if (session.port < 1 || session.port > 65535) return null;
