...
test('Windows metadata keeps app 1.71.20 separate from stable Windows component identities', () => {
...
test('Windows GitHub Actions run name follows Direct-Xfer 1.71.20', () => {
  const workflow = read('.github/workflows/build-windows-csharp.yml');
