# Direct-Xfer 1.60.0 — Windows C# / WinForms
...
- launcher : `1.60.0-launcher35-csharp`
- server host : `1.60.0-serverhost8-csharp`
...
- l’artefact `Direct-Xfer-1.60.0-Windows-CSharp` ;
- l’installateur `Direct-Xfer-Setup-1.60.0.exe`.
