...
(function () {
  ...
  var APP_VERSION = '1.71.50';
  var APP_BUILD = '2026.09.11-pwa513';
...
Object.assign(STRINGS.fr, { imgVersionHistory:'Historique des modifications', imgCompareBeforeAfter:'Comparer avant/après', imgRestoreOriginal:'Revenir à l’original', imgCurrentVersion:'Version actuelle', imgVersionOperations:'Opérations', imgClose:'Fermer', imgRestoreConfirm:'Restaurer cette version ?', imgOriginal:'Originale' });
  ...
  function applyLanguage(next) {
    ...
    if (manifest) {
      ...
      var manifestHref = '/direct-xfer-pwa.webmanifest?v=493';
      if (lang === 'en') manifestHref = '/direct-xfer-pwa-en.webmanifest?v=493';
      else if (lang === 'es') manifestHref = '/direct-xfer-pwa-es.webmanifest?v=493';
  ...
  function registerServiceWorker() {
    ...
    var registrationPromise = navigator.serviceWorker.register('/direct-xfer-pwa-sw.js?v=493', { scope: '/app/' }).then(function (reg) {
      swReg = reg;
