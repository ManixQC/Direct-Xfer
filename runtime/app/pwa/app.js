...
(function () {
  ...
  var APP_VERSION = '1.58.4';
  var APP_BUILD = '2026.08.14-pwa278';
  ...
  function applyLanguage(next) {
    ...
    if (manifest) manifest.href = (lang === 'fr' ? '/direct-xfer-pwa.webmanifest' : '/direct-xfer-pwa-' + lang + '.webmanifest') + '?v=264';
  ...
  function registerServiceWorker() {
    ...
    var registrationPromise = navigator.serviceWorker.register('/direct-xfer-pwa-sw.js?v=264', { scope: '/app/' }).then(function (reg) {
      swReg = reg;
