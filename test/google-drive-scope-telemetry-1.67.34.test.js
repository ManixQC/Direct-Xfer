...
test('1.68.0 Google OAuth session reports requested and broker-returned scopes to the admin UI',async()=>{
  const h=harness();
...
test('1.68.0 preserves the actual broker scope even when least-privilege validation rejects it',async()=>{
...
test('1.68.0 connection modal displays requested scope, broker-returned scope and sensitivity',()=>{
