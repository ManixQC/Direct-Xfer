...
test('1.70.22 lazy references follow the live provider surface without reviving stale methods', () => {
...
test('1.70.22 conflicting bind batches are rejected before candidate provider introspection', () => {
...
test('1.70.22 same-source rebinding revalidates the current provider contract', () => {
