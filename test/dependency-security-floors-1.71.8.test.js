...
test('1.71.37 dependency declarations no longer advertise vulnerable Express/node-forge floors', () => {
...
test('1.71.37 lockfile resolves the dependency floors to the audited safe versions', () => {
  assert.equal(lock.version, '1.71.37');
  assert.equal(lock.packages[''].version, '1.71.37');
