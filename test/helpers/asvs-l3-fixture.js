...
function writeEvidence(dir, options = {}) {
  ...
  let bundle = {
    evidenceVersion:1, profile:'OWASP-ASVS-5.0.0-L3', release:options.release || '1.71.42',
...
function completeL3Config(dir, overrides = {}) {
  ...
  return {
    ASVS_L3_MODE:true, APP_VERSION:'1.71.42', PUBLIC_URL:'https://direct-xfer.example',
