...
<<<<<<< HEAD
  ...
  assert.match(sw, /app\.js\?v=447/);
  assert.match(app, /APP_VERSION = '1\.71\.3'/);
  assert.match(app, /APP_BUILD = '2026\.08\.25-pwa466'/);
  assert.match(loginHtml, /login\.js\?v=321/);
  assert.match(loginHtml, /login-vault\.js\?v=447/);
=======
  assert.match(sw, /2026\.08\.25-pwa467/);
  assert.match(sw, /app\.js\?v=448/);
  assert.match(app, /APP_VERSION = '1\.71\.4'/);
  assert.match(app, /APP_BUILD = '2026\.08\.25-pwa467'/);
  assert.match(loginHtml, /login\.js\?v=321/);
  assert.match(loginHtml, /login-vault\.js\?v=448/);
>>>>>>> eb50626 (v1.71.4)
