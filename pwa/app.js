...
(function () {
  ...
  var APP_VERSION = '1.71.33';
  var APP_BUILD = '2026.08.26-pwa496';
...
Object.assign(STRINGS.fr, { imgVersionHistory:'Historique des modifications', imgCompareBeforeAfter:'Comparer avant/après', imgRestoreOriginal:'Revenir à l’original', imgCurrentVersion:'Version actuelle', imgVersionOperations:'Opérations', imgClose:'Fermer', imgRestoreConfirm:'Restaurer cette version ?', imgOriginal:'Originale' });
  ...
  function applyLanguage(next) {
    ...
    if (manifest) {
      ...
      var manifestHref = '/direct-xfer-pwa.webmanifest?v=477';
      if (lang === 'en') manifestHref = '/direct-xfer-pwa-en.webmanifest?v=477';
      else if (lang === 'es') manifestHref = '/direct-xfer-pwa-es.webmanifest?v=477';
  ...
  function registerServiceWorker() {
    ...
    var registrationPromise = navigator.serviceWorker.register('/direct-xfer-pwa-sw.js?v=477', { scope: '/app/' }).then(function (reg) {
      swReg = reg;
