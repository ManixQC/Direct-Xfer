...
test('1.71.11 launches JavaScript crypto providers through Node for Windows execFile compatibility', (t) => {
...
test('1.71.11 static regex inventory avoids the CodeQL exponential-backtracking pattern', () => {
