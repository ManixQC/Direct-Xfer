# Direct-Xfer 1.63.4 — Windows C# / WinForms
...
- launcher : `1.63.4-launcher52-csharp`
- server host : `1.63.4-serverhost25-csharp`
...
- l’artefact `Direct-Xfer-1.63.4-Windows-CSharp` ;
- l’installateur `Direct-Xfer-Setup-1.63.4.exe`.
