...
test('1.70.28 launches JavaScript crypto providers through Node for Windows execFile compatibility', (t) => {
...
test('1.70.28 static regex inventory avoids the CodeQL exponential-backtracking pattern', () => {
