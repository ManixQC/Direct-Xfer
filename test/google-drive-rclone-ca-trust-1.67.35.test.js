...
test('1.69.0 gives rclone a merged CA bundle even on a minimal runtime',async()=>{
...
test('1.69.0 classifies unknown CA failures instead of generic Google probe failure',async()=>{
...
test('1.69.0 Docker image explicitly installs and validates ca-certificates',()=>{
...
test('1.69.0 admin UI explains an untrusted CA without suggesting TLS bypass',()=>{
