...
test('real server protects and serves the complete health dashboard',{timeout:30000},async()=>{
  ...
  try{
    ...
    for(const asset of ['/server-health-dashboard.js?v=4','/server-health-dashboard.css?v=2']){const r=await fetch(base+asset);assert.equal(r.status,200);}
