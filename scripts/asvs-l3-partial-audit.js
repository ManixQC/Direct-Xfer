...
const controls = [
  ...
  requireAnchors('V10.1.2','OAuth same-browser/session transaction binding',[['oauth-broker/server.js','browserHash'],['oauth-broker/server.js','oauthBrowserBinding'],['lib/server/storage-connector-config.js','browserSessionHash']]),
