...
test('1.59.8 launcher is a conventional C# WinForms UI with no Go launcher left', () => {
  assert.match(launcher, /const string AppVersion = "1\.59\.8"/);
  assert.match(launcher, /const string RuntimeAppBuild = "1\.59\.8-launcher34-csharp"/);
