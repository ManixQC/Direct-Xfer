...
test('1.71.23 launches JavaScript crypto providers through Node for Windows execFile compatibility', (t) => {
...
test('1.71.23 static regex inventory avoids the CodeQL exponential-backtracking pattern', () => {
