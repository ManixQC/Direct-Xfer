...
test('1.71.7 launches JavaScript crypto providers through Node for Windows execFile compatibility', (t) => {
...
test('1.71.7 static regex inventory avoids the CodeQL exponential-backtracking pattern', () => {
