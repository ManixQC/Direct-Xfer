...
test('1.69.3 confirmed connector inventory is not replaced by a stale red load error', () => {
...
test('1.69.3 successful POST or PATCH confirms the inventory before background refresh', () => {
...
test('1.69.3 exact connector POST retries are idempotent', () => {
