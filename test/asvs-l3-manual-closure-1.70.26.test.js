...
<<<<<<< HEAD
  const result=verifyEvidenceBundle(ev.bundle,{ appVersion:'1.71.3', publicUrl:'https://direct-xfer.example', publicKey:ev.keyPair.publicKey });
=======
  const result=verifyEvidenceBundle(ev.bundle,{ appVersion:'1.71.4', publicUrl:'https://direct-xfer.example', publicKey:ev.keyPair.publicKey });
>>>>>>> eb50626 (v1.71.4)
...
<<<<<<< HEAD
  assert.equal(verifyEvidenceBundle(ev.bundle,{appVersion:'1.71.3',publicUrl:'https://other.example',publicKey:ev.keyPair.publicKey}).ok,false);
=======
  assert.equal(verifyEvidenceBundle(ev.bundle,{appVersion:'1.71.4',publicUrl:'https://other.example',publicKey:ev.keyPair.publicKey}).ok,false);
>>>>>>> eb50626 (v1.71.4)
});
...
<<<<<<< HEAD
  assert.equal(verifyEvidenceBundle(forged,{appVersion:'1.71.3',publicUrl:'https://direct-xfer.example',publicKey:ev.keyPair.publicKey}).ok,false);
  assert.equal(verifyEvidenceBundle(ev.bundle,{appVersion:'1.71.3',publicUrl:'https://direct-xfer.example',publicKey:ev.keyPair.publicKey,now:ev.bundle.expiresAt+1}).ok,false);
=======
  assert.equal(verifyEvidenceBundle(forged,{appVersion:'1.71.4',publicUrl:'https://direct-xfer.example',publicKey:ev.keyPair.publicKey}).ok,false);
  assert.equal(verifyEvidenceBundle(ev.bundle,{appVersion:'1.71.4',publicUrl:'https://direct-xfer.example',publicKey:ev.keyPair.publicKey,now:ev.bundle.expiresAt+1}).ok,false);
>>>>>>> eb50626 (v1.71.4)
});
