...
test('Windows metadata keeps app 1.71.2 separate from stable Windows component identities', () => {
...
test('Windows GitHub Actions run name follows Direct-Xfer 1.71.2', () => {
  const workflow = read('.github/workflows/build-windows-csharp.yml');
