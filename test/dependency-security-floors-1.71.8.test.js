...
test('1.71.14 dependency declarations no longer advertise vulnerable Express/node-forge floors', () => {
...
test('1.71.14 lockfile resolves the dependency floors to the audited safe versions', () => {
