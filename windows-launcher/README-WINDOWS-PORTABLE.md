# Direct-Xfer 1.59.8 — Windows C# / WinForms
...
- launcher : `1.59.8-launcher34-csharp`
- server host : `1.59.8-serverhost7-csharp`
...
- l’artefact `Direct-Xfer-1.59.8-Windows-CSharp` ;
- l’installateur `Direct-Xfer-Setup-1.59.8.exe`.
