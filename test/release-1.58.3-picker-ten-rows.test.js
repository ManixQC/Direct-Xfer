...
test('1.60.0 create-share modal is a three-zone bounded grid', () => {
...
test('1.60.0 file picker targets ten visible rows plus parent row', () => {
...
test('1.60.0 release identifiers are synchronized', () => {
  ...
  assert.match(read('windows-launcher','Program.cs'), /RuntimeAppBuild\s*=\s*"1\.60\.0-launcher35-csharp"/);
});
