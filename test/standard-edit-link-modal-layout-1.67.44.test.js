...
test('1.69.0 edit-link modal has a dedicated scroll body with pinned header/actions', () => {
...
test('1.69.0 edit-link options are grouped instead of one unstructured flex row', () => {
  for (const id of [
...
test('1.69.0 keeps every edit control exactly once after reorganizing the modal', () => {
  const ids = [
...
test('1.69.0 access-rule translations no longer collide with Admin accounts', () => {
...
test('1.69.0 reopening the edit dialog starts at the top of its internal scroller', () => {
