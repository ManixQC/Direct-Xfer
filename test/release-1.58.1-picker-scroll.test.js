...
test('1.62.4 create-share dialog has a bounded Firefox-safe scroll body', () => {
...
test('1.62.4 release identifiers are synchronized', () => {
  ...
  assert.match(read('windows-launcher/Program.cs'), /RuntimeAppBuild\s*= "1\.62\.4-launcher45-csharp"/);
});
