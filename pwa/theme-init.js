...
(function () {
  ...
  var release = { version: '1.71.24', build: '2026.08.26-pwa487' };
  ...
  if (!document.querySelector('script[data-dx-admin-advanced]')) {
    ...
    adminScript.src = '/app/admin-advanced.js?v=468';
  ...
  if (!document.querySelector('script[data-dx-admin-audit-connectors]')) {
    ...
    auditConnectorScript.src = '/app/admin-audit-connectors.js?v=468';
