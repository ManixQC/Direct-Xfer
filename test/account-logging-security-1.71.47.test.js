...
test('1.71.47 account bootstrap warnings never log environment-derived values or exception messages', () => {
...
test('1.71.47 keeps account warning call sites restricted to the fixed catalogue', () => {
