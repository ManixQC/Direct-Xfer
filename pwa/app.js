...
(function () {
  ...
  var APP_VERSION = '1.71.48';
  var APP_BUILD = '2026.09.11-pwa511';
...
Object.assign(STRINGS.fr, { imgVersionHistory:'Historique des modifications', imgCompareBeforeAfter:'Comparer avant/après', imgRestoreOriginal:'Revenir à l’original', imgCurrentVersion:'Version actuelle', imgVersionOperations:'Opérations', imgClose:'Fermer', imgRestoreConfirm:'Restaurer cette version ?', imgOriginal:'Originale' });
  ...
  function applyLanguage(next) {
    ...
    if (manifest) {
      ...
      var manifestHref = '/direct-xfer-pwa.webmanifest?v=491';
      if (lang === 'en') manifestHref = '/direct-xfer-pwa-en.webmanifest?v=491';
      else if (lang === 'es') manifestHref = '/direct-xfer-pwa-es.webmanifest?v=491';
  ...
  function registerServiceWorker() {
    ...
    var registrationPromise = navigator.serviceWorker.register('/direct-xfer-pwa-sw.js?v=491', { scope: '/app/' }).then(function (reg) {
      swReg = reg;
