...
test('1.71.17 launches JavaScript crypto providers through Node for Windows execFile compatibility', (t) => {
...
test('1.71.17 static regex inventory avoids the CodeQL exponential-backtracking pattern', () => {
